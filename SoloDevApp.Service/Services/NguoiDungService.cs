        ...
        public async Task<ResponseEntity> LayTatCa()
        {
            try
            {
                ...
                foreach (NguoiDung nguoiDung in dsNguoiDung)
                {
                    ...
                    nguoiDungNew.Skill = JsonConvert.DeserializeObject<List<string>>(nguoiDung.Skill);
                    nguoiDungNew.Certification = JsonConvert.DeserializeObject<List<string>>(nguoiDung.Certification);
                    nguoiDungNew.BookingJob = JsonConvert.DeserializeObject<List<string>>(nguoiDung.BookingJob);
